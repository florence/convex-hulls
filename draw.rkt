...
(define (render pts known . check)
  ...
  (define pts-list (sequence->list pts))
  (define xmax (apply max (map real-part pts-list)))
  (define ymax (apply max (map imag-part pts-list)))
  (define xmin (apply min (map real-part pts-list)))
  (define ymin (apply min (map imag-part pts-list)))  
